...
void Vsim::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/casper/thesis_work/liteX/build/sim/gateware/sim.v", 21, "",
...
void Vsim::_eval(Vsim__Syms* __restrict vlSymsp) {
    ...
    if (((IData)(vlTOPp->sys_clk) & (~ (IData)(vlTOPp->__Vclklast__TOP__sys_clk)))) {
        ...
        vlSymsp->TOP__sim__VexRiscv._sequent__TOP__sim__VexRiscv__38(vlSymsp);
        ...
        vlSymsp->TOP__sim__VexRiscv._sequent__TOP__sim__VexRiscv__39(vlSymsp);
    }
