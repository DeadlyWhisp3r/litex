...
CData/*0:0*/ Vsim_VexRiscv::__Vtable24___PVT__IBusCachedPlugin_fetcherHalt[128];
CData/*0:0*/ Vsim_VexRiscv::__Vtable25___PVT___zz_execute_BRANCH_COND_RESULT[32];
CData/*0:0*/ Vsim_VexRiscv::__Vtable26___PVT__dataCache_1_io_cpu_writeBack_haltIt[64];
CData/*0:0*/ Vsim_VexRiscv::__Vtable27___PVT__dataCache_1_io_cpu_redo[64];
...
void Vsim_VexRiscv::_settle__TOP__sim__VexRiscv__3(Vsim__Syms* __restrict vlSymsp) {
    ...
    vlSymsp->TOP__sim__VexRiscv.__PVT__BranchPlugin_jumpInterface_valid 
        = ((IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__memory_arbitration_isValid) 
           & (IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__execute_to_memory_BRANCH_DO));
    vlSymsp->TOP__sim__VexRiscv.__PVT__when_DebugPlugin_l311 
        = (0U == (((IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__writeBack_arbitration_isValid) 
                   << 1U) | (IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__memory_arbitration_isValid)));
...
void Vsim_VexRiscv::_settle__TOP__sim__VexRiscv__5(Vsim__Syms* __restrict vlSymsp) {
    ...
    vlSymsp->TOP__sim__VexRiscv.__PVT___zz_execute_SRC2_3 
        = ((0xffffeU & vlSymsp->TOP__sim__VexRiscv.__PVT___zz_execute_SRC2_3) 
           | (1U & (vlSymsp->TOP__sim__VexRiscv.__PVT__decode_to_execute_INSTRUCTION 
                    >> 0x1fU)));
    vlSymsp->TOP__sim__VexRiscv.__PVT__when_DebugPlugin_l308 
        = ((IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__execute_arbitration_isValid) 
           & (IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__decode_to_execute_DO_EBREAK));
    vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_injectionPort_ready = 0U;
    if ((4U == (IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__IBusCachedPlugin_injector_port_state))) {
        vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_injectionPort_ready = 1U;
    }
    ...
    vlSymsp->TOP__sim__VexRiscv.__PVT___zz_IBusCachedPlugin_predictionJumpInterface_payload_3 
        = ((0x7fffeU & vlSymsp->TOP__sim__VexRiscv.__PVT___zz_IBusCachedPlugin_predictionJumpInterface_payload_3) 
           | (1U & (vlSymsp->TOP__sim__VexRiscv.__PVT__IBusCachedPlugin_cache__DOT__io_cpu_fetch_data_regNextWhen 
                    >> 0x1fU)));
    vlSymsp->TOP__sim__VexRiscv.__PVT__decode_arbitration_haltItself = 0U;
    if ((2U == (IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__IBusCachedPlugin_injector_port_state))) {
        vlSymsp->TOP__sim__VexRiscv.__PVT__decode_arbitration_haltItself = 1U;
    }
...
void Vsim_VexRiscv::_settle__TOP__sim__VexRiscv__8(Vsim__Syms* __restrict vlSymsp) {
    ...
    vlSymsp->TOP__sim__VexRiscv.__PVT__execute_arbitration_flushIt = 0U;
    if (vlSymsp->TOP__sim__VexRiscv.__PVT__when_DebugPlugin_l308) {
        if (vlSymsp->TOP__sim__VexRiscv.__PVT__when_DebugPlugin_l311) {
            vlSymsp->TOP__sim__VexRiscv.__PVT__execute_arbitration_flushIt = 1U;
        }
    }
    ...
    if (((IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__execute_arbitration_isValid) 
        ...
        if (((IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__CsrPlugin_privilege) 
             < (3U & (vlSymsp->TOP__sim__VexRiscv.__PVT__decode_to_execute_INSTRUCTION 
                      >> 0x1cU)))) {
            vlSymsp->TOP__sim__VexRiscv.__PVT__execute_CsrPlugin_illegalInstruction = 1U;
        }
    }
    ...
    if (((IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__CsrPlugin_privilege) 
         < (3U & (vlSymsp->TOP__sim__VexRiscv.__PVT__decode_to_execute_INSTRUCTION 
                  >> 0x1cU)))) {
        vlSymsp->TOP__sim__VexRiscv.__PVT__when_CsrPlugin_l1719 = 1U;
    }
    ...
    if (vlSymsp->TOP__sim__VexRiscv.__PVT__when_CsrPlugin_l1555) {
        vlSymsp->TOP__sim__VexRiscv.__PVT__CsrPlugin_selfException_payload_code 
            = ((0U == (IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__CsrPlugin_privilege))
                ? 8U : 0xbU);
    }
    ...
    vlSymsp->TOP__sim__VexRiscv.__Vtableidx27 = ((((IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__dataCache_1__DOT__loader_valid) 
    ...
    vlSymsp->TOP__sim__VexRiscv.__PVT__dataCache_1_io_cpu_redo 
        = vlSymsp->TOP__sim__VexRiscv.__Vtable27___PVT__dataCache_1_io_cpu_redo
        [vlSymsp->TOP__sim__VexRiscv.__Vtableidx27];
}
