...
VL_MODULE(Vsim_sim) {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ __PVT__timer_pending_status;
        CData/*0:0*/ __PVT__timer_reload_re;
        CData/*0:0*/ __PVT__timer_status_re;
        CData/*0:0*/ __PVT__timer_status_status;
        ...
        CData/*0:0*/ __PVT__vexriscv_dbus_err;
        CData/*0:0*/ __PVT__vexriscv_debug_bus_ack;
    };
    struct {
        CData/*0:0*/ __PVT__vexriscv_debug_bus_cyc;
        CData/*0:0*/ __PVT__vexriscv_debug_reset;
        CData/*7:0*/ __PVT__vexriscv_i_cmd_payload_address;
        CData/*0:0*/ __PVT__vexriscv_i_cmd_payload_wr;
        CData/*0:0*/ __PVT__vexriscv_i_cmd_valid;
        CData/*0:0*/ __PVT__vexriscv_ibus_err;
        CData/*0:0*/ __PVT__vexriscv_reset_debug_logic;
        CData/*0:0*/ __PVT__vexriscv_transfer_complete;
        CData/*0:0*/ __PVT__vexriscv_transfer_in_progress;
        CData/*0:0*/ __PVT__vexriscv_transfer_wait_for_ack;
        ...
        IData/*31:0*/ __PVT__vexriscv_debug_bus_dat_r;
        IData/*31:0*/ __PVT__vexriscv_i_cmd_payload_data;
        IData/*31:0*/ __PVT__rom_dat0;
        IData/*31:0*/ __PVT__rom[5936];
    ...
    CData/*0:0*/ __Vcellinp__VexRiscv__debugReset;
    CData/*0:0*/ __Vdly__simsoc_ram_bus_ack;
    CData/*3:0*/ __Vdly__uart_tx_fifo_consume;
    CData/*4:0*/ __Vdly__uart_tx_fifo_level0;
    CData/*0:0*/ __Vdly__vexriscv_transfer_in_progress;
    CData/*0:0*/ __Vdly__vexriscv_transfer_complete;
    CData/*0:0*/ __Vdly__vexriscv_transfer_wait_for_ack;
