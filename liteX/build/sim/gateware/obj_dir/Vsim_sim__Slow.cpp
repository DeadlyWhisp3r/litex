...
void Vsim_sim::_initial__TOP__sim__1(Vsim__Syms* __restrict vlSymsp) {
    ...
    vlSymsp->TOP__sim.__PVT__vexriscv_debug_bus_dat_r = 0U;
    ...
    __Vtemp2[1U] = 0x6d656d2eU;
    __Vtemp2[2U] = 0x73696d5fU;
    VL_READMEM_N(true, 8, 37, 0, VL_CVT_PACK_STR_NW(3, __Vtemp2)
    ...
    __Vtemp3[1U] = 0x726f6d2eU;
    __Vtemp3[2U] = 0x73696d5fU;
    VL_READMEM_N(true, 32, 5936, 0, VL_CVT_PACK_STR_NW(3, __Vtemp3)
    ...
    vlSymsp->TOP__sim.__PVT__timer_status_status = 0U;
    ...
    vlSymsp->TOP__sim.__PVT__timer_pending_status = 0U;
    ...
    vlSymsp->TOP__sim.__PVT__ram_bus_ram_bus_ack = 0U;
    vlSymsp->TOP__sim.__PVT__simsoc_ram_bus_ack = 0U;
...
void Vsim_sim::_initial__TOP__sim__2(Vsim__Syms* __restrict vlSymsp) {
    ...
    vlSymsp->TOP__sim.__PVT__vexriscv_transfer_complete = 0U;
    vlSymsp->TOP__sim.__PVT__vexriscv_transfer_in_progress = 0U;
    vlSymsp->TOP__sim.__PVT__vexriscv_transfer_wait_for_ack = 0U;
...
void Vsim_sim::_ctor_var_reset() {
    ...
    __PVT__ram_bus_ram_bus_ack = VL_RAND_RESET_I(1);
    __PVT__ram_bus_ram_bus_cyc = VL_RAND_RESET_I(1);
    __PVT__ram_we = VL_RAND_RESET_I(4);
    ...
    __PVT__simsoc_ram_bus_ack = VL_RAND_RESET_I(1);
    ...
    __PVT__timer_pending_status = VL_RAND_RESET_I(1);
    ...
    __PVT__timer_status_status = VL_RAND_RESET_I(1);
    ...
    __PVT__vexriscv_dbus_err = VL_RAND_RESET_I(1);
    __PVT__vexriscv_debug_bus_ack = VL_RAND_RESET_I(1);
    __PVT__vexriscv_debug_bus_cyc = VL_RAND_RESET_I(1);
    __PVT__vexriscv_debug_bus_dat_r = VL_RAND_RESET_I(32);
    __PVT__vexriscv_debug_reset = VL_RAND_RESET_I(1);
    __PVT__vexriscv_i_cmd_payload_address = VL_RAND_RESET_I(8);
    __PVT__vexriscv_i_cmd_payload_data = VL_RAND_RESET_I(32);
    __PVT__vexriscv_i_cmd_payload_wr = VL_RAND_RESET_I(1);
    __PVT__vexriscv_i_cmd_valid = VL_RAND_RESET_I(1);
    __PVT__vexriscv_ibus_err = VL_RAND_RESET_I(1);
    __PVT__vexriscv_reset_debug_logic = VL_RAND_RESET_I(1);
    __PVT__vexriscv_transfer_complete = VL_RAND_RESET_I(1);
    __PVT__vexriscv_transfer_in_progress = VL_RAND_RESET_I(1);
    __PVT__vexriscv_transfer_wait_for_ack = VL_RAND_RESET_I(1);
    { int __Vi0=0; for (; __Vi0<5936; ++__Vi0) {
    ...
    __Vcellinp__VexRiscv__debugReset = VL_RAND_RESET_I(1);
    __Vdly__simsoc_ram_bus_ack = VL_RAND_RESET_I(1);
    ...
    __Vdly__vexriscv_transfer_in_progress = VL_RAND_RESET_I(1);
    __Vdly__vexriscv_transfer_complete = VL_RAND_RESET_I(1);
    __Vdly__vexriscv_transfer_wait_for_ack = VL_RAND_RESET_I(1);
    __Vdly__uart_rx_fifo_level0 = VL_RAND_RESET_I(5);
    __Vdly__uart_rx_fifo_consume = VL_RAND_RESET_I(4);
    __Vdly__ram_bus_ram_bus_ack = VL_RAND_RESET_I(1);
