...
VL_INLINE_OPT void Vsim_VexRiscv::_sequent__TOP__sim__VexRiscv__18(Vsim__Syms* __restrict vlSymsp) {
    ...
    vlSymsp->TOP__sim__VexRiscv.__Vdly__IBusCachedPlugin_injector_port_state 
        = vlSymsp->TOP__sim__VexRiscv.__PVT__IBusCachedPlugin_injector_port_state;
    ...
    vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_secondCycle 
        = vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_firstCycle;
...
VL_INLINE_OPT void Vsim_VexRiscv::_sequent__TOP__sim__VexRiscv__19(Vsim__Syms* __restrict vlSymsp) {
    ...
    if (vlSymsp->TOP__sim__VexRiscv.__PVT__when_CsrPlugin_l1296) {
    ...
    vlSymsp->TOP__sim__VexRiscv.__PVT__execute_CsrPlugin_wfiWake 
        = ((~ (IData)(vlSymsp->TOP__sim.__Vcellinp__VexRiscv__reset)) 
           & ((0U != (((IData)(vlSymsp->TOP__sim__VexRiscv.__PVT___zz_when_CsrPlugin_l1302_2) 
              ...
              | (IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__CsrPlugin_thirdPartyWake)));
    if (vlSymsp->TOP__sim.__Vcellinp__VexRiscv__reset) {
    ...
    if ((1U & (~ (IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__execute_arbitration_isStuck)))) {
        vlSymsp->TOP__sim__VexRiscv.__PVT__decode_to_execute_ALU_BITWISE_CTRL 
            = (3U & (IData)((vlSymsp->TOP__sim__VexRiscv.__PVT___zz_decode_IS_RS2_SIGNED 
                             >> 0x12U)));
    }
    if ((1U & (~ (IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__execute_arbitration_isStuck)))) {
...
VL_INLINE_OPT void Vsim_VexRiscv::_sequent__TOP__sim__VexRiscv__20(Vsim__Syms* __restrict vlSymsp) {
    ...
    if (vlSymsp->TOP__sim.__Vcellinp__VexRiscv__reset) {
        vlSymsp->TOP__sim__VexRiscv.__Vdly__IBusCachedPlugin_injector_port_state = 0U;
    } else {
        if ((4U & (IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__IBusCachedPlugin_injector_port_state))) {
            if ((1U & (~ ((IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__IBusCachedPlugin_injector_port_state) 
                          >> 1U)))) {
                if ((1U & (~ (IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__IBusCachedPlugin_injector_port_state)))) {
                    vlSymsp->TOP__sim__VexRiscv.__Vdly__IBusCachedPlugin_injector_port_state = 0U;
                }
            ...
            if ((2U & (IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__IBusCachedPlugin_injector_port_state))) {
                if ((1U & (IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__IBusCachedPlugin_injector_port_state))) {
                    if ((1U & (~ (IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__decode_arbitration_isStuck)))) {
                        vlSymsp->TOP__sim__VexRiscv.__Vdly__IBusCachedPlugin_injector_port_state = 4U;
                    }
                } else {
                    vlSymsp->TOP__sim__VexRiscv.__Vdly__IBusCachedPlugin_injector_port_state = 3U;
                }
            } else {
                if ((1U & (IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__IBusCachedPlugin_injector_port_state))) {
                    vlSymsp->TOP__sim__VexRiscv.__Vdly__IBusCachedPlugin_injector_port_state = 2U;
                } else {
                    if (vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_injectionPort_valid) {
                        vlSymsp->TOP__sim__VexRiscv.__Vdly__IBusCachedPlugin_injector_port_state = 1U;
                    }
                }
            }
        }
    ...
    vlSymsp->TOP__sim__VexRiscv.__PVT___zz_when_DebugPlugin_l257 
        = (1U & ((IData)(vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_payload_address) 
                 >> 2U));
    if (vlSymsp->TOP__sim.__Vcellinp__VexRiscv__debugReset) {
        vlSymsp->TOP__sim__VexRiscv.DebugPlugin_debugUsed = 0U;
    } else {
        if (vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_valid) {
            vlSymsp->TOP__sim__VexRiscv.DebugPlugin_debugUsed = 1U;
        }
    }
    if ((1U & (~ (IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__writeBack_arbitration_haltItself)))) {
...
VL_INLINE_OPT void Vsim_VexRiscv::_sequent__TOP__sim__VexRiscv__21(Vsim__Syms* __restrict vlSymsp) {
    ...
    if (vlSymsp->TOP__sim.__Vcellinp__VexRiscv__debugReset) {
        vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_disableEbreak = 0U;
    } else {
        if (vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_valid) {
            if ((0U == (0x3fU & ((IData)(vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_payload_address) 
                                 >> 2U)))) {
                if (vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_payload_wr) {
                    if ((0x40000U & vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_payload_data)) {
                        vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_disableEbreak = 1U;
                    }
                    if ((0x4000000U & vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_payload_data)) {
                        vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_disableEbreak = 0U;
                    }
                }
            }
    ...
    vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_resetIt_regNext 
        = vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_resetIt;
    if (vlSymsp->TOP__sim__VexRiscv.__PVT__when_CsrPlugin_l1390) {
        if ((3U == (IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__CsrPlugin_targetPrivilege))) {
    ...
    if (vlSymsp->TOP__sim.__Vcellinp__VexRiscv__debugReset) {
        vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_haltedByBreak = 0U;
    } else {
        if (vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_valid) {
            if ((0U == (0x3fU & ((IData)(vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_payload_address) 
                                 >> 2U)))) {
                if (vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_payload_wr) {
                    if ((0x2000000U & vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_payload_data)) {
                        vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_haltedByBreak = 0U;
                    }
                }
            }
        ...
        if (vlSymsp->TOP__sim__VexRiscv.__PVT__when_DebugPlugin_l308) {
            if (vlSymsp->TOP__sim__VexRiscv.__PVT__when_DebugPlugin_l311) {
                vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_haltedByBreak = 1U;
            }
        }
    }
    if ((1U & (~ (IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__writeBack_arbitration_haltItself)))) {
    ...
    vlSymsp->TOP__sim__VexRiscv.__PVT__HazardSimplePlugin_writeBackBuffer_payload_address 
        = (0x1fU & (vlSymsp->TOP__sim__VexRiscv.__PVT__memory_to_writeBack_INSTRUCTION 
                    >> 7U));
    if (vlSymsp->TOP__sim.__Vcellinp__VexRiscv__debugReset) {
        vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_stepIt = 0U;
    } else {
        if (vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_valid) {
            if ((0U == (0x3fU & ((IData)(vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_payload_address) 
                                 >> 2U)))) {
                if (vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_payload_wr) {
                    vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_stepIt 
                        = (1U & (vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_payload_data 
                                 >> 4U));
                }
            }
        }
    ...
    if (vlSymsp->TOP__sim.__Vcellinp__VexRiscv__reset) {
        ...
        if (vlSymsp->TOP__sim__VexRiscv.__PVT__when_InstructionCache_l239) {
            if (vlSymsp->TOP__sim.__PVT__ibus_ibus_ack) {
                vlSymsp->TOP__sim__VexRiscv.__Vdly___zz_iBusWishbone_ADR 
...
VL_INLINE_OPT void Vsim_VexRiscv::_sequent__TOP__sim__VexRiscv__22(Vsim__Syms* __restrict vlSymsp) {
    ...
    if (vlSymsp->TOP__sim.__Vcellinp__VexRiscv__reset) {
        ...
        if (vlSymsp->TOP__sim__VexRiscv.__PVT__when_CsrPlugin_l1390) {
            if ((3U == (IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__CsrPlugin_targetPrivilege))) {
                vlSymsp->TOP__sim__VexRiscv.__PVT__CsrPlugin_mstatus_MPP 
                    = vlSymsp->TOP__sim__VexRiscv.__PVT__CsrPlugin_privilege;
            }
        }
    ...
    if ((1U & (~ (IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__execute_arbitration_isStuck)))) {
        vlSymsp->TOP__sim__VexRiscv.__PVT__decode_to_execute_DO_EBREAK 
            = (((~ (IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_haltIt)) 
                & ((IData)((vlSymsp->TOP__sim__VexRiscv.__PVT___zz_decode_IS_RS2_SIGNED 
                            >> 0x20U)) | (((IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_hardwareBreakpoints_0_valid) 
    ...
    if (vlSymsp->TOP__sim__VexRiscv.__PVT__writeBack_arbitration_isValid) {
        vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_busReadDataReg 
            = vlSymsp->TOP__sim__VexRiscv.__PVT___zz_decode_RS2_2;
    }
    if (vlSymsp->TOP__sim__VexRiscv.__PVT__when_DebugPlugin_l308) {
        vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_busReadDataReg 
    ...
    if (vlSymsp->TOP__sim.__Vcellinp__VexRiscv__debugReset) {
        vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_godmode = 0U;
    } else {
        if (((IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_haltIt) 
             & (~ (IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_isPipBusy)))) {
            vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_godmode = 1U;
        }
        if (vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_valid) {
            if ((0U == (0x3fU & ((IData)(vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_payload_address) 
                                 >> 2U)))) {
...
VL_INLINE_OPT void Vsim_VexRiscv::_sequent__TOP__sim__VexRiscv__23(Vsim__Syms* __restrict vlSymsp) {
    ...
    vlSymsp->TOP__sim__VexRiscv.__PVT___zz_iBusWishbone_ADR 
        = vlSymsp->TOP__sim__VexRiscv.__Vdly___zz_iBusWishbone_ADR;
    vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_firstCycle = 0U;
    if (vlSymsp->TOP__sim__VexRiscv.__PVT__debug_bus_cmd_ready) {
        vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_firstCycle = 1U;
    }
    if ((1U & (~ (IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__execute_arbitration_isStuck)))) {
        vlSymsp->TOP__sim__VexRiscv.__PVT__decode_to_execute_FORMAL_PC_NEXT 
...
VL_INLINE_OPT void Vsim_VexRiscv::_sequent__TOP__sim__VexRiscv__25(Vsim__Syms* __restrict vlSymsp) {
    ...
    vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_allowEBreak 
        = ((IData)(vlSymsp->TOP__sim__VexRiscv.DebugPlugin_debugUsed) 
           & (~ (IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_disableEbreak)));
    if (vlSymsp->TOP__sim.__Vcellinp__VexRiscv__debugReset) {
        vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_resetIt = 0U;
    } else {
        if (vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_valid) {
            if ((0U == (0x3fU & ((IData)(vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_payload_address) 
                                 >> 2U)))) {
                if (vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_payload_wr) {
                    if ((0x10000U & vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_payload_data)) {
                        vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_resetIt = 1U;
                    }
                    if ((0x1000000U & vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_payload_data)) {
                        vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_resetIt = 0U;
                    }
                }
            }
    ...
    if (vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_valid) {
        if ((0x10U == (0x3fU & ((IData)(vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_payload_address) 
                                >> 2U)))) {
            if (vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_payload_wr) {
                vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_hardwareBreakpoints_0_pc 
                    = (0x7fffffffU & (vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_payload_data 
                                      >> 1U));
            }
        }
    }
    if (vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_valid) {
        if ((0x10U != (0x3fU & ((IData)(vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_payload_address) 
                                >> 2U)))) {
            if ((0x11U == (0x3fU & ((IData)(vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_payload_address) 
                                    >> 2U)))) {
                if (vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_payload_wr) {
                    vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_hardwareBreakpoints_1_pc 
                        = (0x7fffffffU & (vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_payload_data 
    ...
    if (vlSymsp->TOP__sim.__Vcellinp__VexRiscv__debugReset) {
        vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_hardwareBreakpoints_0_valid = 0U;
    } else {
        if (vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_valid) {
            if ((0U != (0x3fU & ((IData)(vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_payload_address) 
                                 >> 2U)))) {
                if ((0x10U == (0x3fU & ((IData)(vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_payload_address) 
                                        >> 2U)))) {
                    if (vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_payload_wr) {
                        vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_hardwareBreakpoints_0_valid 
                            = (1U & vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_payload_data);
                    }
                }
            }
...
VL_INLINE_OPT void Vsim_VexRiscv::_sequent__TOP__sim__VexRiscv__26(Vsim__Syms* __restrict vlSymsp) {
    ...
    // Body
    if (vlSymsp->TOP__sim.__Vcellinp__VexRiscv__debugReset) {
        vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_hardwareBreakpoints_1_valid = 0U;
    } else {
        if (vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_valid) {
            if ((0U != (0x3fU & ((IData)(vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_payload_address) 
                                 >> 2U)))) {
                if ((0x10U != (0x3fU & ((IData)(vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_payload_address) 
                    ...
                    if ((0x11U == (0x3fU & ((IData)(vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_payload_address) 
                                            >> 2U)))) {
                        if (vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_payload_wr) {
                            vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_hardwareBreakpoints_1_valid 
                                = (1U & vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_payload_data);
                        }
                    }
                }
    ...
    vlSymsp->TOP__sim__VexRiscv.__PVT__BranchPlugin_inDebugNoFetchFlag = 0U;
    if (vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_godmode) {
        vlSymsp->TOP__sim__VexRiscv.__PVT__BranchPlugin_inDebugNoFetchFlag = 1U;
    }
    vlSymsp->TOP__sim__VexRiscv.__PVT___zz_when_DBusCachedPlugin_l472 = 0U;
    if (vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_godmode) {
        vlSymsp->TOP__sim__VexRiscv.__PVT___zz_when_DBusCachedPlugin_l472 = 1U;
    }
    vlSymsp->TOP__sim__VexRiscv.__PVT__CsrPlugin_forceMachineWire = 0U;
    if (vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_godmode) {
        vlSymsp->TOP__sim__VexRiscv.__PVT__CsrPlugin_forceMachineWire = 1U;
    }
    if (vlSymsp->TOP__sim.__Vcellinp__VexRiscv__debugReset) {
        vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_haltIt = 0U;
    } else {
        if (vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_valid) {
            if ((0U == (0x3fU & ((IData)(vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_payload_address) 
                                 >> 2U)))) {
                if (vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_payload_wr) {
                    if ((0x20000U & vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_payload_data)) {
                        vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_haltIt = 1U;
                    }
                    if ((0x2000000U & vlSymsp->TOP__sim.__PVT__vexriscv_i_cmd_payload_data)) {
                        vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_haltIt = 0U;
                    }
        ...
        if (vlSymsp->TOP__sim__VexRiscv.__PVT__when_DebugPlugin_l324) {
            if (vlSymsp->TOP__sim__VexRiscv.__PVT__decode_arbitration_isValid) {
                vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_haltIt = 1U;
            }
        }
    }
    vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_isPipBusy 
        = ((0U != (((IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__writeBack_arbitration_isValid) 
                    << 3U) | (((IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__memory_arbitration_isValid) 
                               << 2U) | (((IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__execute_arbitration_isValid) 
                                          << 1U) | (IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__decode_arbitration_isValid))))) 
           | (IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__IBusCachedPlugin_incomingInstruction));
    if (vlSymsp->TOP__sim__VexRiscv.__PVT__IBusCachedPlugin_iBusRsp_stages_2_input_ready) {
...
VL_INLINE_OPT void Vsim_VexRiscv::_sequent__TOP__sim__VexRiscv__27(Vsim__Syms* __restrict vlSymsp) {
    ...
    vlSymsp->TOP__sim__VexRiscv.__PVT__CsrPlugin_allowEbreakException = 1U;
    if (vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_allowEBreak) {
        vlSymsp->TOP__sim__VexRiscv.__PVT__CsrPlugin_allowEbreakException = 0U;
    }
    ...
    vlSymsp->TOP__sim__VexRiscv.__PVT__CsrPlugin_allowException = 1U;
    if (vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_godmode) {
        vlSymsp->TOP__sim__VexRiscv.__PVT__CsrPlugin_allowException = 0U;
    }
    vlSymsp->TOP__sim__VexRiscv.__PVT__CsrPlugin_mstatus_MIE 
        = vlSymsp->TOP__sim__VexRiscv.__Vdly__CsrPlugin_mstatus_MIE;
    ...
    vlSymsp->TOP__sim__VexRiscv.__PVT__dataCache_1__DOT__stageB_flusher_counter 
        = vlSymsp->TOP__sim__VexRiscv.__Vdly__dataCache_1__DOT__stageB_flusher_counter;
    vlSymsp->TOP__sim__VexRiscv.__PVT__CsrPlugin_privilege = 3U;
    if (vlSymsp->TOP__sim__VexRiscv.__PVT__CsrPlugin_forceMachineWire) {
        vlSymsp->TOP__sim__VexRiscv.__PVT__CsrPlugin_privilege = 3U;
    }
...
VL_INLINE_OPT void Vsim_VexRiscv::_sequent__TOP__sim__VexRiscv__28(Vsim__Syms* __restrict vlSymsp) {
    ...
    if (vlSymsp->TOP__sim__VexRiscv.__PVT__dataCache_1__DOT__when_DataCache_l829) {
        vlSymsp->TOP__sim__VexRiscv.__PVT__dataCache_1__DOT__stageB_mmuRsp_isIoAccess 
            = vlSymsp->TOP__sim__VexRiscv.__PVT__dataCache_1_io_cpu_memory_mmuRsp_isIoAccess;
    }
    if ((1U & (~ (IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__execute_arbitration_isStuck)))) {
        vlSymsp->TOP__sim__VexRiscv.__PVT__decode_to_execute_MEMORY_WR 
            = (1U & (IData)((vlSymsp->TOP__sim__VexRiscv.__PVT___zz_decode_IS_RS2_SIGNED 
    ...
    vlSymsp->TOP__sim__VexRiscv.__PVT__when_CsrPlugin_l1296 
    ...
    vlSymsp->TOP__sim__VexRiscv.__PVT__CsrPlugin_thirdPartyWake = 0U;
    if (vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_haltIt) {
        vlSymsp->TOP__sim__VexRiscv.__PVT__CsrPlugin_thirdPartyWake = 1U;
    }
    vlSymsp->TOP__sim__VexRiscv.__PVT__CsrPlugin_allowInterrupts = 1U;
    if (((IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_haltIt) 
         | (IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_stepIt))) {
        vlSymsp->TOP__sim__VexRiscv.__PVT__CsrPlugin_allowInterrupts = 0U;
    }
    vlSymsp->TOP__sim__VexRiscv.__PVT__debug_bus_rsp_data 
        = vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_busReadDataReg;
    if ((1U & (~ (IData)(vlSymsp->TOP__sim__VexRiscv.__PVT___zz_when_DebugPlugin_l257)))) {
        vlSymsp->TOP__sim__VexRiscv.__PVT__debug_bus_rsp_data 
            = ((0xfffffffeU & vlSymsp->TOP__sim__VexRiscv.__PVT__debug_bus_rsp_data) 
               | (IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_resetIt));
        vlSymsp->TOP__sim__VexRiscv.__PVT__debug_bus_rsp_data 
            = ((0xfffffffdU & vlSymsp->TOP__sim__VexRiscv.__PVT__debug_bus_rsp_data) 
               | ((IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_haltIt) 
                  << 1U));
        vlSymsp->TOP__sim__VexRiscv.__PVT__debug_bus_rsp_data 
            = ((0xfffffffbU & vlSymsp->TOP__sim__VexRiscv.__PVT__debug_bus_rsp_data) 
               | ((IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_isPipBusy) 
                  << 2U));
        vlSymsp->TOP__sim__VexRiscv.__PVT__debug_bus_rsp_data 
            = ((0xfffffff7U & vlSymsp->TOP__sim__VexRiscv.__PVT__debug_bus_rsp_data) 
               | ((IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_haltedByBreak) 
                  << 3U));
        vlSymsp->TOP__sim__VexRiscv.__PVT__debug_bus_rsp_data 
            = ((0xffffffefU & vlSymsp->TOP__sim__VexRiscv.__PVT__debug_bus_rsp_data) 
               | ((IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_stepIt) 
                  << 4U));
    }
    if (vlSymsp->TOP__sim.__Vcellinp__VexRiscv__reset) {
    ...
    vlSymsp->TOP__sim__VexRiscv.__PVT__dataCache_1_io_cpu_memory_mmuRsp_isIoAccess 
        = (1U & (vlSymsp->TOP__sim__VexRiscv.__PVT__execute_to_memory_REGFILE_WRITE_DATA 
                 >> 0x1fU));
    if (((IData)(vlSymsp->TOP__sim__VexRiscv.__PVT___zz_when_DBusCachedPlugin_l472) 
         & (~ (IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__dataCache_1__DOT__stageA_request_wr)))) {
        vlSymsp->TOP__sim__VexRiscv.__PVT__dataCache_1_io_cpu_memory_mmuRsp_isIoAccess = 1U;
    }
    ...
    vlSymsp->TOP__sim__VexRiscv.__PVT__when_DebugPlugin_l324 
        = ((IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__DebugPlugin_stepIt) 
           & (IData)(vlSymsp->TOP__sim__VexRiscv.__PVT__IBusCachedPlugin_incomingInstruction));
