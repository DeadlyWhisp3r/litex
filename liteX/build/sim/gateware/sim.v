...
assign vexriscv_debug_bus_cyc = (shared_cyc & slave_sel[0]);
assign simsoc_ram_bus_cyc = (shared_cyc & slave_sel[1]);
assign ram_bus_ram_bus_cyc = (shared_cyc & slave_sel[2]);
assign interface0_cyc = (shared_cyc & slave_sel[3]);
always @(*) begin
    shared_ack <= 1'd0;
    shared_ack <= (((vexriscv_debug_bus_ack | simsoc_ram_bus_ack) | ram_bus_ram_bus_ack) | interface0_ack);
    if (done) begin
        shared_ack <= 1'd1;
    end
end
assign shared_err = (((vexriscv_debug_bus_err | simsoc_ram_bus_err) | ram_bus_ram_bus_err) | interface0_err);
always @(*) begin
    shared_dat_r <= 32'd0;
    shared_dat_r <= (((({32{slave_sel_r[0]}} & vexriscv_debug_bus_dat_r) | ({32{slave_sel_r[1]}} & simsoc_ram_bus_dat_r)) | ({32{slave_sel_r[2]}} & ram_bus_ram_bus_dat_r)) | ({32{slave_sel_r[3]}} & interface0_dat_r));
    if (done) begin
...
always @(*) begin
    ...
    case (grant)
        1'd0: begin
            array_muxed0 <= ibus_ibus_adr;
        end
        default: begin
            array_muxed0 <= dbus_dbus_adr;
        end
    endcase
end
always @(*) begin
    ...
    case (grant)
        1'd0: begin
            array_muxed1 <= ibus_ibus_dat_w;
        end
        default: begin
            array_muxed1 <= dbus_dbus_dat_w;
        end
    endcase
end
always @(*) begin
    ...
    case (grant)
        1'd0: begin
            array_muxed2 <= ibus_ibus_sel;
        end
        default: begin
            array_muxed2 <= dbus_dbus_sel;
        end
    endcase
end
always @(*) begin
    ...
    case (grant)
        1'd0: begin
            array_muxed3 <= ibus_ibus_cyc;
        end
        default: begin
            array_muxed3 <= dbus_dbus_cyc;
        end
    endcase
end
always @(*) begin
    ...
    case (grant)
        1'd0: begin
            array_muxed4 <= ibus_ibus_stb;
        end
        default: begin
            array_muxed4 <= dbus_dbus_stb;
        end
    endcase
end
always @(*) begin
    ...
    case (grant)
        1'd0: begin
            array_muxed5 <= ibus_ibus_we;
        end
        default: begin
            array_muxed5 <= dbus_dbus_we;
        end
    endcase
end
always @(*) begin
    ...
    case (grant)
        1'd0: begin
            array_muxed6 <= ibus_ibus_cti;
        end
        default: begin
            array_muxed6 <= dbus_dbus_cti;
        end
    endcase
end
always @(*) begin
    ...
    case (grant)
        1'd0: begin
            array_muxed7 <= ibus_ibus_bte;
        end
        default: begin
            array_muxed7 <= dbus_dbus_bte;
        end
    endcase
end
...
always @(posedge sys_clk_1) begin
    ...
    vexriscv_debug_reset <= vexriscv_reset_debug_logic;
...
//------------------------------------------------------------------------------
// Memory rom: 5936-words x 32-bit
//------------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2024-03-01 14:47:31.
//------------------------------------------------------------------------------
